...
const Gallery: React.FC<GalleryProps> = ({
  ...
  return (
    <>
      <section className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 xl:grid-cols-2 gap-[10px] w-full my-[30px] overflow-hidden">
        {/* ===== store billede ===== */}
        ...
        {/* ===== små billeder ===== */}
        <main className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 gap-[10px] h-[70vh]">
          {smallImages.map((image: Image) => (
            <img
              className="object-cover w-full h-[35vh] sm:h-[35vh] md:h-[35vh] xl:h-[35vh] cursor-pointer"
              key={image.id}
